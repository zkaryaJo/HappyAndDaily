        ...
        return new CommandLineRunner() {
            ...
            private void createSystemMenu() {
                ...
                for(int i=0; i<10; i++){
                    ...
                    depth2Menu.setDepth1("2");
                    depth2Menu.setDepth2(""+i);
                    list.add(depth2Menu);
                }

                list.forEach(item ->{
                    switch (item.getDepth1()){
                        case "0": item.setSystemMenuName("홈"); break;
                        case "1": item.setSystemMenuName("소개"); break;
                        case "2":
                            if (item.getDepth2() == null) {
                                item.setSystemMenuName("메뉴"); break;
                            }
                            switch (item.getDepth2()) {
                                case "0": item.setSystemMenuName("대표메뉴"); break;
                                case "1": item.setSystemMenuName("컵과일, 과일 도시락"); break;
                                case "2": item.setSystemMenuName("과일 단품"); break;
                                case "3": item.setSystemMenuName("와플"); break;
                                case "4": item.setSystemMenuName("일만 드시기 심심하시죠"); break;
                                case "5": item.setSystemMenuName("행복과일상 Cafe (커피 & 차)"); break;
                                case "6": item.setSystemMenuName("생 과일 주스"); break;
                                case "7": item.setSystemMenuName("떡볶이"); break;
                                case "8": item.setSystemMenuName("대용량 1L 음료"); break;
                                case "9": item.setSystemMenuName("요거트 아이스크림"); break;
                            }
                        case "3": item.setSystemMenuName("장바구니");break;
                        case "4": item.setSystemMenuName("로그인");break;
                        default: break;
                    };
                });
            ...
            private void createMenu() {
                ...
                menu1.setImgPath("images/menu/01_fruits/01_cup_fruit.jpeg");
                menu1.setStars(2);
                ...
                menu2.setImgPath("images/menu/01_fruits/02_apple_mango.jpeg");
                menu2.setStars(4);
                ...
                menu3.setImgPath("images/menu/01_fruits/03_strawberry.jpeg");
                menu3.setStars(5);
...
//                list.forEach(item -> menuRepository.save(item));
